...
tokens.colors.light.cardBorder = '#2FD674'
tokens.colors.light.primary = '#2ED573'
tokens.colors.light.secondary = '#61D361'
...
// tokens.colors.light.textSubtle = '#282828'
// tokens.colors.dark.input = '#F2F2F2'
tokens.colors.light.gradientBubblegum = 'linear-gradient(-426deg, #2FD674 -79%, rgb(45 114 210 / -7%) 81%);'
